...
import pt.goncalorodrigues.serializer.GenderSerializer;
...
//    @JsonProperty("first_name")
    ...
    @JsonInclude(JsonInclude.Include.NON_NULL) // só renderizado quando não é null
    private String lastName;

    @JsonInclude(JsonInclude.Include.NON_EMPTY) // só renderizado quando não é vazio
